...
The am predictor is a numeric class so for better interpretability we convert it to a factor class instead, converting 0s to Automatic and 1s to Manual.
